...
#### 2. Создаем каталоги для хранения постоянных данных:
...
#### Добавляем в `.gitignore` записи с этого [suggested .gitignore content from GitHub]([https://raw.githubusercontent.com/github/gitignore/master/Python.gitignore](https://raw.githubusercontent.com/github/gitignore/master/Python.gitignore), а также(обязательно):
    # Django stuff:
    local_settings.py
    persistentdata/*
    .db_settings
